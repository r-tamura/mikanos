...
namespace {
  ...
  /** @brief device[num_device]に情報を書き込みnum_deviceをインクリメントする. */
  ...
  */
  ...
  /** @brief 指定デバイス番号の各ファンクションをスキャンする.
...
void InitializePCI() {
  ...
  for (int i = 0; i < pci::num_device; ++i) {
    ...
    Log(kDebug, "%d.%d.%d: vend %04x, class %08x, head %02\n",
